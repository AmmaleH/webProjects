      ...
      <div class="container">
        ...
        <div class="order-wrap clearfix">
          ...
          <div class="total fr">
            ...
            >元
            <a href="javascirpt:;" class="btn" @click="confirm">去结算</a>
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    toggleAll() {
      ...
      //   this.renderData(res);
      // });
      this.allCheckeded = this.list.every((item) => item.productSelected);
      if (this.allChecked) {
